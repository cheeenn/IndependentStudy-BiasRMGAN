...
parser.add_argument('--lrD', type=float, default=0.0001) # Learning Rate for D
parser.add_argument('--lrG', type=float, default=0.0001) # Learning Rate for G
...
# misc
parser.add_argument('--db', type=str, default='celebA')  # Model Tmp Save
